          ...
          <div className="container">
            <div className={css.aboutWrapper}>
              ...
              <p className={css.textAbout}>
                ...
                компанії представлено як власними брендами ТМ ASKOLD, ТМ BATIK,
                ТМ Домашній чай, так і брендами, що ексклюзивно імпортуються з
                різних країн світу. Наявність власної системи дистриб’юції та
                представництв в усіх регіонах України сприяють успішному
                розвитку компанії в каналах збуту.
              </p>
            </div>
          </div>
        )}
