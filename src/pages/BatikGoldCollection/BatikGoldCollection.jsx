...
import batikGoldImg7 from "../../images/batik/batik-gold/7.jpg";
import batikGoldImg8 from "../../images/batik/batik-gold/8.jpg";
          ...
          <li className={css.batikGoldCollectionItem}>
            <div className={css.batikGoldCollectionOverlayWrap}>
              <NavLink to="/batik-gold-rubinova-nich">
                ...
                />
                <div className={css.overlay}>
                  <p>Batik Gold РУБІНОВА НІЧ, 50 г, 25 пакетиків у конвертах</p>
                </div>
              </NavLink>
            </div>
          </li>
          ...
          <li className={css.batikGoldCollectionItem}>
            <div className={css.batikGoldCollectionOverlayWrap}>
              <NavLink to="/batik-gold-tseilonske-sontse">
                ...
                <div className={css.overlay}>
                  <p>
                    Batik Gold ЦЕЙЛОНСЬКЕ СОНЦЕ, 50 г, 25 пакетиків у конвертах
                  </p>
                </div>
              </NavLink>
            </div>
          ...
          <li className={css.batikGoldCollectionItem}>
            <div className={css.batikGoldCollectionOverlayWrap}>
              <NavLink to="/batik-gold-tseilonskyi-vysokohirnyi">
                ...
                />
                <div className={css.overlay}>
                  <p>Batik Gold ЦЕЙЛОНСЬКИЙ ВИСОКОГІРНИЙ, 50 г, 25 пакетиків</p>
                </div>
              </NavLink>
            </div>
          </li>
