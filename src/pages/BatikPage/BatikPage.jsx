        ...
        <div className={css.mainBatikSection}>
          <div className="container">
            ...
            <article>
              ...
              <p>
                «Batik» – це чай з найкращих плантацій світу. Це завжди найвища
                якість, це яскравий характер і витончений аромат. Це втілення
                життєвої мудрості та справжніх незмінних цінностей.
              </p>
              <p>«Batik» – це мій чай!</p>
            </article>
          </div>
        </div>
        <div className={css.batikCollectionSection}>
          <img src={batikCollectionImg} alt="Batik Collection" />
