            ...
            <ul className={css.factsAboutCoffeeList}>
              ...
              <li className={css.factsAboutCoffeeItem}>
                ...
                <p className={css.factsAboutCoffeeText}>
                  ...
                  Лувак» полягає в тому, що цивети (хижі звірята) поїдають
                  стиглі плоди кавового дерева (кавові вишні), перетравлюють
                  оточуючу кавові зерна м’яку оболонку, боби ж не
                  перетравлюються. Люди вибирають їх з посліду, миють, сушать та
                  обсмажують. Іноді зерна продають у вигляді цілих екскрементів.
                  Цей процес робить каву особливою та надзвичайно дорогою – ціни
                  на неї можуть сягати 700 доларів за фунт!
                </p>
              </li>
            </ul>
