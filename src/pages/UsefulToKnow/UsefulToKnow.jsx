          ...
          <ul className={css.usefulToKnowList}>
            ...
            <li className={css.usefulToKnowItem}>
              ...
              <p className={css.usefulToKnowText}>
                ...
                зерен. Кава – це не просто напій, а справжнє мистецтво, яке
                завоювало серця мільйонів людей по всьому світу.
              </p>
              <NavLink to="/">
                <p className={css.usefulToKnowlink}>Читати далі </p>
              </NavLink>
            ...
            <li className={css.usefulToKnowItem}>
              ...
              <p className={css.usefulToKnowText}>
                Як визначити якість чаю? Щодня мільйони людей у всьому світі
                насолоджуються чудовими смаковими якостями та користю для
                здоров’я від вживання чаю. Як же визначити якість листового чаю⁉
              </p>
              <NavLink to="/">
                <p className={css.usefulToKnowlink}>Читати далі </p>
              </NavLink>
            ...
            <li className={css.usefulToKnowItem}>
              ...
              <p className={css.usefulToKnowText}>
                СТАНДАРТИ ЧАЙНОГО ЛИСТА ЦІЛИЙ ЛИСТ РEKOE Верхнє молоде листя
                чаю, бруньки вже розпустились. Цей сорт чаю має коротше листя
                ніж О.Р.А та скручене по особливому. Чай з яскравим
              </p>
              <NavLink to="/">
                <p className={css.usefulToKnowlink}>Читати далі </p>
              </NavLink>
