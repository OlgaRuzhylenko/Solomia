      ...
      <div className="container">
        <div className={css.footerSectionBox}>
          ...
          <p className={css.footerCopy}>
            © 2023 Solomia. При використанні матеріалів сайту (в т.ч
            фотографій), активне гіперпосилання на сайт www.solomia.com.ua
            обов’язкове
          </p>
          <div className={css.nameAddressSocialMediaWrapper}>
            <div className={css.nameAddressWrapper}>
              <p className={css.footerName}>
                Торгово-виробнича компанія SOLOMIA
              </p>
